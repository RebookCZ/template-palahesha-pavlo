<nav class="main-nav">
    ...
    <ul class="nav">
        ...
        <li class="main-button" style="display: flex; flex-direction: column; align-items: center;">
        <a onclick="openModal('signupModal')" id="openModalBtn" style="margin-bottom: 8px;">Sign Up</a>
